      ...
      <div class="col-md-8"> <!-- Memperlebar lebar kartu -->
        <div class="card">
          <div class="card-body shadow-sm">
            <h1 class="text-center mb-4">Selamat Datang di SIKAT - <span>BATA</span> JTI!</h1> <!-- Tambahkan mb-4 -->
            ...
            <form method="POST" style="margin-top: 50px;">
              <div class="mb-3 row">
                <label for="username" class="form-label col-sm-4 text-start">Nama Pengguna<span class="text-danger">*</span></label>
                <div class="col-sm-8">
