...
<body>
  ...
  <div class="content" style="margin-left: 300px; padding: 60px 20px;">
    ...
    <div class="mt-4">
      <h2 id="studentName">Mahasiswa 123</h2>
      <hr>
      <p id="studentDetails">
        NIM: <span id="studentNIM">1231231234</span><br />
        Program Studi: DIII Pengembangan Piranti Lunak Situs<br />
    ...
    <div class="row d-flex justify-content-between align-items-center">
      ...
      <div class="col-4 d-flex justify-content-end">
        <div class="btn btn-sm bg-info d-flex align-items-center rounded">
          <img src="../assets/icons/verifCheck.svg" alt="">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row d-flex justify-content-between align-items-center">
      ...
      <div class="card p-3 mt-4 shadow-sm">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div>
            <button class="btn btn-info btn-sm ms-3"><img src="../assets/icons/verifCheck.svg" alt=""></button>
            <button class="btn btn-danger btn-sm ms-2"><img src="../assets/icons/notVerif.svg" alt=""></button>
          </div>
        </div>
      </div>
