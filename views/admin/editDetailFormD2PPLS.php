...
<body class="d-flex flex-column min-vh-100">
    ...
    <div id="mainPage" style="margin-left: 300px; padding: 60px 20px;">
        <div class="d-flex justify-content-start align-items-center mb-4">
            ...
            <h3>Edit Detail Form D-II Pengembangan Perangkat Lunak Situs</h3>
  ...
  <a href="editMoreDetailFormD2PPLS.php" class="btn btn-info text-white me-md-2" type="button">Edit</a>
