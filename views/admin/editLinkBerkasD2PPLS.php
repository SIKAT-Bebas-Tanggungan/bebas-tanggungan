...
<body class="d-flex flex-column min-vh-100">
    ...
    <div id="mainPage" style="margin-left: 300px; padding: 60px 20px;">
        <div class="d-flex justify-content-start align-items-center mb-4">
            ...
            <h3>Edit Link Berkas D-II Pengembangan Perangkat Lunak Situs</h3>
      ...
      <div class="card p-4 border-0 shadow-sm card-form   " id="formCreateAdm" style="border-radius: 10px; margin-top: 0; border-top-left-radius: 10px; border-top-right-radius: 10px;">
        <form>
          ...
          <div class="row mb-4 align-items-center">
            <label for="username" class="col-sm-3 col-form-label fw-medium">Link</label>
            <div class="col-sm-9">
              <input type="text" class="form-control px-3 py-2" id="link" placeholder="Masukkan Link">
            </div>
          </div>
        </form>
