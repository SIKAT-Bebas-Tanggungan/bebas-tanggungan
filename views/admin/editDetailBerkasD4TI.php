...
<body class="d-flex flex-column min-vh-100">
    ...
    <div id="mainPage" style="margin-left: 300px; padding: 60px 20px;">
        <div class="d-flex justify-content-start align-items-center mb-4">
            ...
            <h3>Edit Detail Berkas D-IV Teknik Informatika</h3>
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-end mb-4">
            <a href="editLinkBerkasD4TI.php" class="btn btn-info text-white me-md-2" type="button">Edit</a>
        ...
        <script src="../assets/js/admin//berkasD4TI.js"></script>
</body>
