    ...
    <div class="card p-4 border-0 shadow-sm card-form" id="formCreateMhs" style="border-radius: 10px; margin-top: 0; border-top-left-radius: 0; border-top-right-radius: 0;">
      <form method="POST">
        <div class="row mb-4 align-items-center">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control rounded-pill px-3 py-2" name="nama_mahasiswa" placeholder="Nama">
          </div>
        </div>
        <div class="row mb-4 align-items-center">
          <label for="username" class="col-sm-3 col-form-label fw-semibold">NIM:</label>
          <div class="col-sm-9">
            <input type="text" class="form-control rounded-pill px-3 py-2" name="nim" placeholder="NIM">
          </div>
        </div>
        <div class="row mb-4 align-items-center">
          <label for="phone" class="col-sm-3 col-form-label fw-semibold">Prodi:</label>
          <div class="col-sm-9">
            <input type="text" class="form-control rounded-pill px-3 py-2" name="prodi" placeholder="Program Studi">
          </div>
        </div>
        <div class="row mb-4 align-items-center">
          <label for="phone" class="col-sm-3 col-form-label fw-semibold">Angkatan:</label>
          <div class="col-sm-9">
            <input type="text" class="form-control rounded-pill px-3 py-2" name="angkatan" placeholder="Tahun Angkatan">
          </div>
        </div>
        <div class="d-flex justify-content-end">
          <button type="submit" id="addMhsButton" class="btn btn-info text-white fw-bold px-4 rounded-3" style="width: 150px;">Tambah</button>
        </div>
      </form>
    </div>
  </div>
