...
<body class="d-flex flex-column vh-100" style="font-family: 'Poppins', sans-serif;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        <div class="container-fluid">
            <a class="navbar-brand d-flex align-items-center ms-2" href="#">
                <img src="http://localhost/bebas-tanggungan/views/assets/images/logoSikatBata.svg" alt="Logo" class="d-inline-block align-text-top">    
    ...
    <div class="d-flex justify-content-center align-items-center flex-grow-1">
        <div class="text-center">
            <img src="http://localhost/bebas-tanggungan/views/assets/images/404Error.png" alt="404 Error Image" class="img-fluid mb-5" style="max-width: 300px;">
