  ...
  <div class="container my-5">
    ...
    <div class="card p-4 shadow-sm mb-4">
      ...
      <form>
        ...
        <!-- Card 3: Surat Pernyataan Publikasi -->
        <div class="card p-4 shadow-sm mb-4">
          <h5 class="fs-5 fw-bold">Surat Pernyataan Publikasi<span class="text-danger">*</h5>
        ...
        <div class="card p-4 shadow-sm mb-4">
          <h5 class="fs-5 fw-bold">Tanda Terima Penyerahan Laporan Akhir/Skripsi<span class="text-danger">*</h5>
        ...
        <!-- Card 6: Scan TOEIC -->
        <div class="card p-4 shadow-sm mb-4">
          <h5 class="fs-5 fw-bold">Scan TOEIC<span class="text-danger">*</h5>
