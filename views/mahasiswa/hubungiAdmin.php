  ...
  <div class="container my-5">
    ...
    <div class="card p-4 shadow-sm">
      ...
      <h2 class="mt-2 fs-5 fw-medium">Jika Memiliki Kendala atau pertanyaan lebih lanjut , Bisa Menghubungi Nomor Yang Tertera Berikut (WhatsApp):</h5>
        <ul class="mt-4"><img src="http://localhost/bebas-tanggungan/views/assets/icons/adminWA.svg" alt="adminWA" class="me-2"><strong>Bu Yanti</strong> (Verifikator) - <a href="">08380066233</a> (Chat Only)</ul>
        <ul class="mt-2"><img src="http://localhost/bebas-tanggungan/views/assets/icons/adminWA.svg" alt="adminWA" class="me-2"><strong>Mas Anggi</strong> (Verifikator) - <a href="">0895630505222</a> (Chat Only)</ul>
        <ul class="mt-2"><img src="http://localhost/bebas-tanggungan/views/assets/icons/adminWA.svg" alt="adminWA" class="me-2"><strong>Bu Titis</strong> (Admin D2PPLS) - <a href="">085790686586</a> (chat Only)</ul>
    </div>
  </div>
